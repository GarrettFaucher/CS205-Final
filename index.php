...
<html lang="en">
    ...
    <body>
    <div class = "cursorM" style="background-image: url('background.jpg'); background-repeat: no-repeat; background-attachment:fixed; background-size: 100% 100%;">

        <h1><strong>Mars Weather</strong></h1>

    <figure class="rightside">
    <img class="marsRo" alt="Mars Rover." width="400" height="400" src="insight.jpg">
        <figcaption><strong>The Majestic Mars Rover.</strong></figcaption>
    </figure>
        ...
        <p><strong>Elliot Heinrich</strong></p>
